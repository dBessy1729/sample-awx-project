pipeline {
    agent any
    environment {
        TF_VAR_gcp_project = "qwiklabs-gcp-02-55a5847bb774"
        TF_VAR_bucket = "tf-remote-state-student_03_45d95a06c687-30086-24494"
        REPOSITORY = "https://github.com/dBessy1729/sample-awx-project.git"
